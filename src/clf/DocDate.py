...
class DocDate(GeneralClf):
    ...
    def is_candidate(date):
        # return DocDate.is_candidate2(date)
    ...
    def is_candidate2(date):
        ...
        for months in DocDate.MONTHS_DICT:
    ...
    #         best_candidate = list(filter(lambda x: x[2] == min_date, candidates))[0]
